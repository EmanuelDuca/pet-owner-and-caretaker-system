...
public class PetServiceService extends ServiceServiceGrpc.ServiceServiceImplBase
{
    ...
    @Autowired
    public PetServiceService(UserDAOInterface userDao, AnnouncementDAOInterface announcementDAO, PetServiceRequestDAOInterface careServiceRequestDAO)
    {
...
//        var serviceRequest = careServiceRequestDAO.createServiceRequest(\initiator, recipient, announcement));
